...
<head>
    ...
    <title>ABI Bank SignUp  Form</title>
</head>
<body class = "bg-dark text-white">
<h3 class="text-center">ABI Bank SignUp  Form</h3>
<div class="container mt-5">
    ...
    <form action="./signupAccount" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="password" class="form-control" id="password" placeholder="Enter Password" name="confirmPassword">
        </div>
        ...
        <button type="submit" class="btn btn-primary">SignUp Account</button>
    </form>
</div>
